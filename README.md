...
A passionate **Full Stack & Python Backend Developer** with expertise in **Django, Flask, FastAPI, React**, and **DevOps-based deployments**.  
I build **scalable backend systems**, **LLM-powered tools**, and **production-ready full-stack applications** that solve real-world problems.

I love working with **cloud technologies, automation, containerization, and AI/ML integration**, and I'm always exploring new tools to improve performance and scalability.
...
✔️ LLM-integrated RAG systems & chatbots  
✔️ Cloud & containerized deployments  
✔️ REST APIs & backend services  
✔️ Role-based dashboards & admin portals  
